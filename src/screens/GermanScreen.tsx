...
// Functional component for GermanScreen
export default function GermanScreen() {
  ...
  useEffect(() => {
    checkStar(); // Check if German language is starred
  ...
  async function checkStar() {
    if (await LanguageReaderWriter.isLanguageStarred("German")) {
      setStarred(true);
      setSaved(true);
    }
  }
  ...
  const handleLike = async () => {
    if (!starred) {
      if (!saved) {
        LanguageReaderWriter.addLanguages("German"); // Add German language to starred
      } else {
        console.log("language is already starred");
      }
      setStarred((isStarred) => !isStarred);
    } else {
      LanguageReaderWriter.deleteLangauge("German"); // Remove German language from starred
      setSaved(false);
      setStarred((isStarred) => !isStarred);
    }
  };
    ...
    return (
      <>
        <View style={styles.container}>
          ...
          >
            These are Lyraquist's recommended German songs. If you are looking
